...
@section('content')
    <div class="wrapper container-fluid">
        <form action="{{route('movies.store')}}" class="form-horizontal" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <label class="col-xs-2 control-label">Базовое изображение</label>
                <div class="col-xs-8">
